...
echo "$DIR_EXES/ManipVecteur LectureBool /media/cyrilwendl/Data/VeriteTerrain/RPG_2012_029/RPG_2012_029.shp emprise.ori mask/culture.tif" >> bashtmp.sh 
...
$DIR_EXES/Ech_noif InverseBool mask/bati.tif mask/bati.tif
$DIR_EXES/Ech_noif InverseBool mask/bati.tif mask/bati.tif
...
$DIR_EXES/Ech_noif InverseBool mask/route.tif mask/route.tif
$DIR_EXES/Ech_noif InverseBool mask/route.tif mask/route.tif
...
$DIR_EXES/Legende label2RVB $DIR_BASH/legende_gt.txt train_tout.rle train.visu.tif # visualisation
cp proba_SPOT6.tfw train.visu.tfw

# masque binaire
$DIR_EXES/Legende aggrege $DIR_BASH/legende_agg.txt train_tout.rle train_tout_bin.rle
rm -Rf ./mask/
