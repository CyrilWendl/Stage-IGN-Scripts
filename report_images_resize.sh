...
for file in Classified/classif_S2_urbain Classified/classif_regul_urbain Regul/regul_proba_Fusion_Min_100_1000_100_0_100_70_100_200_0_0_0 Fusion/Classified/classif_Fusion_Min; do
	convert $DIR_SAVE/Regul_Fusion/$file.visu.tif -resize 1000X1000 $DIR_SAVE/web/R2_T${TILE_SPOT6}_$(basename $file).jpg
	#overlay map
...
for n in 3 8 15 20 30; do
	convert $DIR_SAVE/Regul_Fusion/Seg/regul_seg_maj_$n.visu.tif -resize 1000X1000 $DIR_SAVE/web/T${TILE_SPOT6}_regul_seg_maj_$n.jpg
	#overlay map
