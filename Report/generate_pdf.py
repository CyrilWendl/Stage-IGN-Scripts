...
project_path = '/media/cyrilwendl/15BA65E227EC1B23/visu_all.qgs'

# and this
template_path = '/home/cyrilwendl/DeveloppementBase/Scripts/template-5cl.qpt'
...
def make_pdf():
    ...
    composition.exportAsPDF('/media/cyrilwendl/15BA65E227EC1B23/report.pdf')
