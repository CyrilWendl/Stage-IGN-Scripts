...
for seg_cut in ${seg_cuts[@]};do
	...
	# create visu.tif
	$DIR_EXES/Legende label2RVB $DIR_BASH/../tools/legende.txt regul_seg_maj_$seg_cut.tif regul_seg_maj_$seg_cut.visu.tif
	cp ../proba_regul_urbain.tfw regul_seg_maj_$seg_cut.visu.tfw
done
