...
for subdir in "./Classified" "./Fusion_all/Classified" "./Fusion_all_weighted/Classified" "./Regul" ; do
	...
	for i in *.visu.tif; do
		...
		composite -blend 30% $DIR_SAVE/web/${REGION}_T${TILE_SPOT6}_Im_SPOT6_crop.jpg $DIR_SAVE/web/${REGION}_T${TILE_SPOT6}_${i%.visu.tif}.jpg overlay_T${TILE_SPOT6}_${i%.visu.tif}.jpg
